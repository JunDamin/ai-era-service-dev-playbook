...
| `population_sgg_kosis.json` | **시군구 인구·밀도·고령비율 (2020~2025)** | **KOSIS** DT_1B040A3·DT_1YL20631 | 드릴용. 키=`data[geo시도코드][시군구명]`. **KOSIS 278개**(행정코드) vs **지도(geo) 250개** — 이름 매칭분만 실값: 밀도 **217**·고령 **229**, 미매칭 geo 단위는 드릴 시 샘플 폴백 |
