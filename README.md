...
| 폴더/파일 | 역할 | 상태 |
|---|---|---|
| `CLAUDE.md` | 운영 지침(Claude Code 자동 로드) | ✅ |
| `AGENTS.md` | **도구 무관 표준 진입점**(Codex·Cursor·Gemini 등도 네이티브 인식) | ✅ |
...
| `playbook/03-demo.md` | 데모(피치) 플레이북 — 검증 시나리오를 'S-tier' 데모로 | ✅ |
...
| `.claude/skills/` | **동봉 스킬**(planning-interview·design-polish·demo-prep — clone하면 자동 세팅) · 안내: `claude-craft/skills-setup.md` | ✅ |
| `BACKLOG.md` | 검토 후 의도적으로 미룬 것(시작 조건 포함) | ✅ |
